...
namespace DVLD.Applications
{
    ...
    public partial class frmAddUpdateLocalDrivingLicesnseApplication : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            int LicenseClassID = clsLicenseClass.Find(cbLicenseClass.Text).LicenseClasseID;
            ...
            //check if Person Has License of the same License Class
            ...
            _LocalDrivingLicenseApplication.ApplicationTypeID = (int)clsApplication.enApplicationType.NewInternationalLicense;
        ...
        {
            DateTime dt = clsPerson.Find(_LocalDrivingLicenseApplication.ApplicantPersonID).DateOfBirth;

            DateTime AgeToHaveLicense = dt.AddYears(clsLicenseClass.GetMinimumAllowedAgeByLicenseClassID(_LocalDrivingLicenseApplication.LicenseClassID));

            if (AgeToHaveLicense < DateTime.Now)
            {
                MessageBox.Show("Error: You show Other License Class", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                cbLicenseClass.Focus();
            }
        }
